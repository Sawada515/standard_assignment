...
void dc_motor_set_pwm_frequency(dc_motor_t *this, unsigned int freq)
{
...
unsigned int dc_motor_get_angle(dc_motor_t *this)
{
...
unsigned int dc_motor_get_duty(dc_motor_t *this)
{
	return this->duty;
}
